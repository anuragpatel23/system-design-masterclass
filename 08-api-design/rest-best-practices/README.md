...
## 2. Status codes and errors — the contract's error half

Use the code families precisely, because **clients and infrastructure branch on them**: retry logic retries 5xx/429 but not 4xx; gateways alert on 5xx rates.
...
## 3. Versioning — the part that makes it an architecture question
...
## 4. The rest of the professional checklist
